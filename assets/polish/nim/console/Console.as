   ...
   function Console(target)
   {
      ...
      function neonScroller(_sb)
      {
         ...
         _loc2_.setTransform({ra:34,rb:26,ga:30,gb:26,ba:30,bb:30,aa:100,ab:0});
      }
      ...
      function drawBuddyList(_context, listW, listH)
      {
         function reorderBuddyList()
         {
            function makeSectionHeader(nm, txt, yy, col)
            {
               ...
               _context.listBuddies.createTextField(nm,_context.listBuddies.getNextHighestDepth(),4,yy,220,18);
         ...
         function createBuddyItem(_context, xnode, cWidth, cHeight)
         {
            ...
            with(_context["listItem" + _loc5_])
            {
               ...
               with(infoClip)
               {
                  ...
                  lineTo(_loc7_ - 76,0);
                  lineTo(_loc7_ - 102,52);
                  lineTo(0,52);
                  lineTo(0,0);
                  endFill();
                  var _loc13_ = _loc7_ - 102;
                  var _loc14_ = "linear";
                  var _loc15_ = [4342351,4342351];
                  var _loc16_ = [85,0];
                  var _loc17_ = [0,255];
                  var _loc18_ = new flash.geom.Matrix();
                  _loc18_.createGradientBox(_loc13_,52,0,0,0);
                  beginGradientFill(_loc14_,_loc15_,_loc16_,_loc17_,_loc18_);
                  moveTo(0,0);
                  lineTo(_loc13_,0);
                  lineTo(_loc13_,2);
                  lineTo(0,2);
                  ...
                  lineTo(0,16);
                  endFill();
                  infoClip.createTextField("name_txt",1,0,5,_loc13_,22);
                  ...
                  infoClip.createTextField("loc_txt",2,0,28,_loc13_,20);
