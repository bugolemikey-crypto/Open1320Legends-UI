class classes.Console
{
   ...
   function Console(target)
   {
      function refreshConverse(_subject)
      {
         ...
         with(_subject)
         {
            ...
            if(classes.Console.panelNum == 1)
            {
               ...
               _loc11_ = new flash.filters.GlowFilter(0,1,20,20,1,2,true);
               _loc12_ = [];
               _loc12_[0] = _loc11_;
               tb1.filters = _loc12_;
         ...
         function createBuddyItem(_context, xnode, cWidth, cHeight)
         {
            ...
            with(_context["listItem" + _loc5_])
            {
               ...
               with(infoClip)
               {
                  ...
                  lineTo(0,0);
                  endFill();
                  var _loc12_ = _loc7_ - 102;
                  var _loc13_ = "linear";
                  var _loc14_ = [3538671,3538671];
                  var _loc15_ = [85,0];
                  var _loc16_ = [0,255];
                  var _loc17_ = new flash.geom.Matrix();
                  _loc17_.createGradientBox(_loc12_,52,0,0,0);
                  ...
                  lineTo(0,16);
                  endFill();
                  infoClip.createTextField("name_txt",1,0,5,_loc12_,22);
                  ...
                  _loc18_.bold = true;
                  _loc18_.align = "left";
                  _loc18_.color = 15790320;
                  name_txt.setNewTextFormat(_loc18_);
                  name_txt.text = xnode.attributes.n;
                  infoClip.createTextField("loc_txt",2,0,28,_loc12_,20);
      ...
      var _loc4_ = new Color(pnl.lines);
      _loc4_.setRGB(16726051);
      pnl.lines2._y = 167;
      classes.Drawing.midLines(pnl.lines2,_loc1_);
      var _loc5_ = new Color(pnl.lines2);
      ...
      pnl.refreshMe = function(forceRedraw)
      {
         ...
         pnl.togMinimize._x = pnl.bgGrad._width - 31;
