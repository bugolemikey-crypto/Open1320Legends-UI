class classes.ui.SweetDropdown2b
{
   ...
   function createItemBlock(theIndex, itemText, showScroller)
   {
      ...
      ib.createTextField("itemText",ib.getNextHighestDepth(),5,2,150,30);
   ...
   function destroy()
   {
      var _loc3_ = classes.ui.SweetDropdown2b.dropdownCollection.length;
      var _loc2_ = 0;
      while(_loc2_ < _loc3_)
      {
         if(classes.ui.SweetDropdown2b.dropdownCollection[_loc2_] == this)
         {
            classes.ui.SweetDropdown2b.dropdownCollection.splice(_loc2_,1);
            _loc3_ = _loc3_ - 1;
         }
         _loc2_ = _loc2_ + 1;
      }
