class classes.ui.SweetDropdown2b3
{
   ...
   function destroy()
   {
      var _loc3_ = classes.ui.SweetDropdown2b3.dropdownCollection.length;
      var _loc2_ = 0;
      while(_loc2_ < _loc3_)
      {
         if(classes.ui.SweetDropdown2b3.dropdownCollection[_loc2_] == this)
         {
            classes.ui.SweetDropdown2b3.dropdownCollection.splice(_loc2_,1);
            _loc3_ = _loc3_ - 1;
         }
         _loc2_ = _loc2_ + 1;
      }
